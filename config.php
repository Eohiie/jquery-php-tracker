...
$_SERVER['tracker'] = array(
	...
	'db_user'           => 'tracker',        /* username used to connect to mysql */
	'db_pass'           => 'ZCN2wcrH2G89CBht',            /* password used to connect to mysql */
	'db_name'           => 'tracker',	  /* name of the PeerTracker database */
